...
public final class Blocks {
    ...
    public void setBlockOfQuartzEnrichedIron(final Supplier<Block> blockOfQuartzEnrichedIron) {
        this.blockOfQuartzEnrichedIron = requireNonNull(blockOfQuartzEnrichedIron);
    }

    public void setBlockOfQuartzEnrichedCopper(final Supplier<Block> blockOfQuartzEnrichedCopper) {
